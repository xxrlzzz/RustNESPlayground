...
BUILD_TYPE=release
BUILD_FLAG="-q --lib --no-default-features --features use_sdl2"
...
cp ./target/$AARC64_TARGET/$BUILD_TYPE/$TARGET_NAME ./$Playground/android/$AARC64_DIST_DIR
